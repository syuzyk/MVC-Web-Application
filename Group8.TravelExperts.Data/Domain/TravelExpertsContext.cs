...
namespace Group8.TravelExperts.Data.Domain
{
    public partial class TravelExpertsContext : DbContext
    {
        ...
        public virtual DbSet<BoDetOld> BoDetOlds { get; set; }
        public virtual DbSet<Booking> Bookings { get; set; }
        public virtual DbSet<BookingDetail> BookingDetails { get; set; }
        public virtual DbSet<Class> Classes { get; set; }
        public virtual DbSet<CreditCard> CreditCards { get; set; }
        public virtual DbSet<Customer> Customers { get; set; }
        public virtual DbSet<CustomersAuthentication> CustomersAuthentications { get; set; }
        public virtual DbSet<CustomersReward> CustomersRewards { get; set; }
        public virtual DbSet<CustsOld> CustsOlds { get; set; }
        ...
        public virtual DbSet<SupsOld> SupsOlds { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BookingDetail>(entity =>
            {
                ...
                entity.HasOne(d => d.Booking)
                    ...
                    .HasForeignKey(d => d.BookingId)
                    .HasConstraintName("FK__BookingDe__Booki__06CD04F7");
            });
            ...
            modelBuilder.Entity<Customer>(entity =>
            {
                ...
                entity.HasOne(d => d.Agent)
                    ...
                    .HasConstraintName("FK__Customers__Agent__75A278F5");
            });
            ...
            modelBuilder.Entity<CustomersAuthentication>(entity =>
            {
                ...
                entity.HasOne(d => d.Customer)
                    .WithOne(p => p.CustomersAuthentication)
                    .HasForeignKey<CustomersAuthentication>(d => d.CustomerId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            modelBuilder.Entity<CustsOld>(entity =>
            {
                entity.HasKey(e => e.CustomerId)
                    .HasName("aaaaaCustomers_PK")
                    .IsClustered(false);

                entity.ToTable("Custs_OLD");
            ...
            {
                entity.HasKey(e => new { e.PackageId, e.ProductId, e.SupplierId })
                    .HasName("PK__Packages__4C2B1FC6832E4D3E");
                ...
                entity.HasOne(d => d.Package)
                    ...
                    .HasForeignKey(d => d.PackageId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Packages___Packa__6FE99F9F");

                entity.HasOne(d => d.ProductsSupplier)
                    .WithMany(p => p.PackagesProductsSuppliers)
                    .HasForeignKey(d => new { d.ProductId, d.SupplierId })
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Packages_Product__70DDC3D8");
            });

            modelBuilder.Entity<PpsOld>(entity =>
            {
                entity.HasKey(e => new { e.PackageId, e.ProductSupplierId })
                    .HasName("aaaaaPackages_Products_Suppliers_PK")
                    .IsClustered(false);

                entity.ToTable("PPS_OLD");
            ...
            modelBuilder.Entity<Product>(entity =>
            {
                ...
                entity.HasIndex(e => e.ProdName, "UQ__Products__F5BC0F58A3A2591A")
                    .IsUnique();
            ...
            modelBuilder.Entity<ProductsSupplier>(entity =>
            {
                entity.HasKey(e => new { e.ProductId, e.SupplierId })
                    .HasName("PK__Products__E0B2A0A660043234");
                ...
                entity.HasOne(d => d.Product)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Products___Produ__6B24EA82");

                entity.HasOne(d => d.Supplier)
                    .WithMany(p => p.ProductsSuppliers)
                    .HasForeignKey(d => d.SupplierId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Products___Suppl__6C190EBB");
            });

            modelBuilder.Entity<PsOld>(entity =>
            {
                entity.HasKey(e => e.ProductSupplierId)
                    .HasName("aaaaaProducts_Suppliers_PK")
                    .IsClustered(false);

                entity.ToTable("PS_OLD");
            ...
            {
                entity.HasIndex(e => e.SupName, "UQ__Supplier__C13D2C4AC788F727")
                    .IsUnique();
            ...
            modelBuilder.Entity<SupsOld>(entity =>
            {
                entity.HasKey(e => e.SupplierId)
                    .HasName("aaaaaSuppliers_PK")
                    .IsClustered(false);

                entity.ToTable("Sups_OLD");
